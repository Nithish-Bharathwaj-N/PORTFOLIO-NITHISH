    ...
    <div className="bg-white dark:bg-black min-h-screen w-full grid place-content-center py-16 px-4 md:px-8 lg:px-16 relative">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center max-w-5xl mx-auto relative text-neutral-900 dark:text-white px-4 space-y-1 md:space-y-2">
          {[
            { text: "Threats detected. Vulnerabilities patched.", color: "#0ea5e9", delay: 0 },
            { text: "Systems secured. AI that adapts.", color: "#8b5cf6", delay: 0.15 },
            { text: "One engineer at the intersection", color: "#10b981", delay: 0.3 },
            { text: "of cybersecurity and intelligence.", color: "#f59e0b", delay: 0.45 }
          ].map((line, i) => (
