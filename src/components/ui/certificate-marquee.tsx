...
const certificates = [
  "/certificate/rootaccess-ctf-iiest.jpg",
  "/certificate/trae-notion-hackathon.jpg",
  "/certificate/wooble-queue-cure.jpg",
  "/certificate/hackbriven-trae-cert.jpg",
  "/certificate/aws-genai-virtual-internship.jpg",
  ...
  "/certificate/cisco-python-essentials-2.png",
  "/certificate/cisco-python-essentials-1-1.png",
];
...
export function CertificateShowcase() {
  ...
  return (
    <section className="relative w-full bg-background overflow-hidden pb-32">
          ...
          <div className="space-y-6 w-full">
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-none leading-relaxed lg:whitespace-nowrap">
                Verified certifications & hackathon recognitions in Cybersecurity, AI, Cloud Infrastructure, and Full-Stack Engineering.
              </p>
            </div>
          </div>
      ...
      {/* Parallax Gallery - 3 columns displaying full variety of certificates */}
      <div className="w-full max-w-[1800px] mx-auto px-4 md:px-8 lg:px-12">
        ...
        >
          ...
          <Column images={[certificates[6], certificates[7], certificates[8], certificates[9], certificates[10], certificates[0]]} y={y2} />
          <Column images={[certificates[4], certificates[3], certificates[2], certificates[1], certificates[0], certificates[5]]} y={y3} />
        </div>
      </div>
