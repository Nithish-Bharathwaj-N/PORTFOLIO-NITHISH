...
const GITHUB_USER = "Nithish-Bharathwaj-N";

const PINNED_REPOS = [
  {
    name: "SubAERO",
    desc: "Aerospace Digital Twin & PHM Platform for HAL Tejas turbojet engines. Top 8 Finalist — Aerothon 2026 (HAL & IIT Indore). Built with React 19, Three.js, Blender & FastAPI with 98.7%–99.9% ML R² accuracy.",
    stars: 4,
    forks: 1,
    lang: "TypeScript",
    url: "https://github.com/Nithish-Bharathwaj-N/SubAERO"
  },
  {
    name: "Securox",
    desc: "Autonomous cyber risk intelligence & attack surface monitoring platform. Features real-time threat detection, automated vulnerability assessment dashboards, and AI-powered risk scoring.",
    stars: 3,
    forks: 0,
    lang: "TypeScript",
    url: "https://github.com/Nithish-Bharathwaj-N/Securox"
  },
  {
    name: "Voyage-AI",
    desc: "AI-powered travel planning platform that generates fully personalised day-by-day itineraries. Integrates Gemini AI, Google Maps, real-time weather, and budget optimisation for seamless trip planning.",
    stars: 5,
    forks: 1,
    lang: "TypeScript",
    url: "https://github.com/Nithish-Bharathwaj-N/Voyage-AI"
  },
  {
    name: "QUEUE-CURE---AI",
    desc: "AI-powered smart healthcare queue management system. Digitizes hospital queues with AI wait-time estimation, QR check-in, live token tracking via Socket.IO, and doctor schedule dashboards.",
    stars: 3,
    forks: 0,
    lang: "JavaScript",
    url: "https://github.com/Nithish-Bharathwaj-N/QUEUE-CURE---AI"
  },
  {
    name: "FinSight",
    desc: "Intelligent personal finance dashboard with AI-driven spending analysis, budget tracking, investment portfolio insights, and predictive forecasting — all in a sleek real-time UI.",
    stars: 2,
    forks: 0,
    lang: "TypeScript",
    url: "https://github.com/Nithish-Bharathwaj-N/FinSight"
  }
];
      ...
      try {
        ...
        setData({
          ...
          stats: {
            ...
            totalCommits: 313,
            totalRepos: userData.public_repos ?? 16,
            stars: totalStars
          },
