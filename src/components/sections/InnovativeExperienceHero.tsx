...
const NODES_DATA: Record<string, NodeData[]> = {
    education: [
        { label: 'Chennai Inst of Tech', description: 'B.E. CSE (Cyber Security) Student (CGPA: 8.48/10).', orbitIndex: 0, position: 0.1, imageUrl: "/images/timeline-cit-college.png" },
        { label: 'AWS Academy GenAI', description: '10-Week AICTE & EduSkills Cloud Internship.', orbitIndex: 1, position: 0.25, imageUrl: "/images/timeline-aws-internship.png" },
        { label: 'Aerothon 2026', description: 'Top 8 National Finalist (HAL & IIT Indore).', orbitIndex: 0, position: 0.45, imageUrl: "/images/subaero-preview.jpg" },
        { label: 'LeetCode CP', description: 'Rating 1788 · 550+ Problems Solved.', orbitIndex: 1, position: 0.65, imageUrl: "/images/timeline-leetcode-cp.png" },
        { label: 'Securox Cyber Risk', description: 'Autonomous Attack Surface Monitoring.', orbitIndex: 0, position: 0.85, imageUrl: "/images/timeline-securox.png" },
        { label: 'Queue Cure AI', description: 'Smart Healthcare Queue Management System.', orbitIndex: 1, position: 0.05, imageUrl: "/images/queuecure-preview.jpg" },
    ],
    journey: [
        { label: 'Aerothon Finalist', description: 'Top 8 National Aerospace Hackathon Finalist (HAL & IIT Indore).', orbitIndex: 0, position: 0.15, imageUrl: "/images/subaero-preview.jpg" },
        { label: 'AWS GenAI Intern', description: '10-Week Virtual Intern on AWS Cloud & LLM Architectures.', orbitIndex: 1, position: 0.35, imageUrl: "/images/timeline-aws-internship.png" },
        { label: 'Securox Architect', description: 'Building Autonomous Cyber Risk Intelligence Platform.', orbitIndex: 0, position: 0.55, imageUrl: "/images/timeline-securox.png" },
        { label: 'Competitive Programmer', description: '550+ Solved with 1788 Rating & 118-day streak.', orbitIndex: 1, position: 0.75, imageUrl: "/images/timeline-leetcode-cp.png" },
        { label: 'SubAERO 3D Lead', description: 'Built Aerospace 3D WebGL Digital Twin for HAL Tejas.', orbitIndex: 0, position: 0.9, imageUrl: "/images/subaero-preview.jpg" },
        { label: 'CIT CSE Student', description: 'Specializing in Network Security & AI Engineering.', orbitIndex: 1, position: 0.02, imageUrl: "/images/timeline-cit-college.png" },
    ],
    experience: [
        { label: 'SubAERO 3D WebGL', description: 'Lead Developer for HAL Tejas 3D Engine Twin.', orbitIndex: 0, position: 0.2, imageUrl: "/images/subaero-preview.jpg" },
        { label: 'Securox Platform', description: 'Autonomous Attack Surface & Threat Monitoring.', orbitIndex: 1, position: 0.45, imageUrl: "/images/timeline-securox.png" },
        { label: 'AWS GenAI Intern', description: 'Cloud LLM Architecture & Prompt Engineering.', orbitIndex: 0, position: 0.6, imageUrl: "/images/timeline-aws-internship.png" },
        { label: 'Voyage AI Planner', description: 'LLM Travel Planner with Budget Optimization.', orbitIndex: 1, position: 0.8, imageUrl: "/images/voyage-preview.jpg" },
        { label: 'Queue Cure System', description: 'Real-time Hospital Queue Tracking with Socket.IO.', orbitIndex: 0, position: 0.95, imageUrl: "/images/queuecure-preview.jpg" },
        { label: 'FinSight Dashboard', description: 'AI Financial Analytics & Banking Interface.', orbitIndex: 1, position: 0.1, imageUrl: "/images/e-commerce.jpg" },
    ]
};
