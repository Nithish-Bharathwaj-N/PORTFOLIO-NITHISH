...
export function HeroVisual({ isExiting = false }: { isExiting?: boolean }) {
  ...
  return (
    ...
    >
      ...
      {/* ── Vibrant & Crisp Blended Background Portrait on Right Side ── */}
      <motion.div
      ...
      >
        <Image
          ...
          priority
        />
        {/* Soft Left Fade Gradient - Ensures photo blends smoothly without bleeding into text */}
      ...
      {/* ── Right-Side Profile Badge overlapping Photo ── */}
      <motion.div
      ...
      <main className="relative flex-1 flex flex-col justify-center pt-24 pb-12 md:pt-40 md:pb-20 z-10 max-w-[105rem] w-full mx-auto">
        <div className="flex relative gap-2 px-4 md:px-12 w-full max-w-full md:max-w-[56vw] flex-col justify-center items-start text-left">
          ...
          {/* Line 3: & AI + 2 Stacked Rows of Badges (2 badges in each row) */}
          <div className="relative flex items-center gap-4 md:gap-5 flex-nowrap">
            ...
            {/* 4 Badges in 2 stacked lines next to & AI (2 badges in each line) */}
            <motion.div
          ...
          {/* LeetCode & Achievements Stats Tag */}
          <motion.p
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 pt-6 border-t border-foreground/15">
            ...
            <div className="flex flex-wrap items-center gap-3 sm:gap-6">
              ...
              <div className="flex items-center flex-wrap gap-2">
                ...
                <a
                  ...
                  className="flex items-center gap-1.5 text-xs font-semibold px-3 py-1.5 rounded-full bg-white/5 border border-white/10 hover:border-sky-500/50 hover:bg-sky-500/10 hover:text-sky-400 text-zinc-300 transition-all duration-300 shadow-sm"
                ...
                {/* GitHub */}
                <a
                  href={personal.socialLinks.find(s => s.platform === 'GitHub')?.url || 'https://github.com/Nithish-Bharathwaj-N'}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-1.5 text-xs font-semibold px-3 py-1.5 rounded-full bg-white/5 border border-white/10 hover:border-purple-500/50 hover:bg-purple-500/10 hover:text-purple-400 text-zinc-300 transition-all duration-300 shadow-sm"
                ...
                {/* LinkedIn */}
                <a
                  href={personal.socialLinks.find(s => s.platform === 'LinkedIn')?.url || 'https://www.linkedin.com/in/nithish-bharathwaj-n-847a00379'}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-1.5 text-xs font-semibold px-3 py-1.5 rounded-full bg-white/5 border border-white/10 hover:border-blue-500/50 hover:bg-blue-500/10 hover:text-blue-400 text-zinc-300 transition-all duration-300 shadow-sm"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-1.5 text-xs font-semibold px-3 py-1.5 rounded-full bg-white/5 border border-white/10 hover:border-amber-500/50 hover:bg-amber-500/10 hover:text-amber-400 text-zinc-300 transition-all duration-300 shadow-sm"
                  title="LeetCode (500+ Solved, 1771 Rating)"
                >
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider px-3.5 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 hover:bg-emerald-500 hover:text-black transition-all duration-300 shadow-sm"
