...
const CERTIFICATE_POOL = [
    "rootaccess-ctf-iiest.jpg",
    "trae-notion-hackathon.jpg",
    "wooble-queue-cure.jpg",
    "hackbriven-trae-cert.jpg",
    "aws-genai-virtual-internship.jpg",
    "cisco-python-essentials-1.jpg",
    "cisco-cybersecurity.png",
    "cisco-modern-ai.png",
    "cisco-os-basics.png",
    "cisco-python-essentials-2.png",
    "cisco-python-essentials-1-1.png",
];
