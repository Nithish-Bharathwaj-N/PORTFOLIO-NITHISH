    ...
    return (
        <div className="w-full max-w-6xl mx-auto p-4 md:p-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {/* Chennai Institute of Technology Box (Left) */}
                <motion.div 
                ...
                >
                    ...
                    <div className="p-8 relative z-10 transition-transform duration-500 group-hover:translate-x-1">
                        <div className="flex items-center gap-2 mb-4">
                            <span className="text-xs font-bold uppercase tracking-widest text-neutral-500 dark:text-neutral-400 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">Higher Education • 2025 – 2029</span>
                        </div>
                        <h3 className="text-3xl font-black text-neutral-900 dark:text-white mb-4">Chennai Institute of Technology</h3>
                        <p className="text-sm text-neutral-600 dark:text-neutral-400 leading-relaxed">
                            B.E. Computer Science & Engineering (Cyber Security Specialization). CGPA: 8.48/10. Core focus: Network security, ethical hacking, cryptography, AI engineering, and full-stack development. Active in 15+ hackathons with 5+ national finalist appearances.
                        </p>
                    </div>
                    ...
                    <div className="flex-1 flex items-center justify-center relative p-8 mt-auto border-t border-black/10 dark:border-white/10 bg-gradient-to-b from-transparent to-black/5 dark:to-white/5 overflow-hidden">
                        ...
                        <div className="absolute inset-0">
                            <Image
                                ...
                                fill
                                className="object-cover opacity-25 dark:opacity-35 blur-[1px] scale-110 group-hover:scale-105 transition-transform duration-700"
                            />
                        ...
                        <div className="relative z-10 flex flex-col items-center transition-transform duration-500 group-hover:scale-105">
                            ...
                            <div className="flex flex-wrap gap-2 justify-center mb-4">
                                {["CGPA 8.48/10", "Cybersecurity", "B.E. CSE"].map(s => (
                            ...
                            <p className="text-[10px] font-mono text-white/90 uppercase tracking-widest bg-black/50 px-2 py-1 rounded backdrop-blur-sm border border-white/10 group-hover:border-blue-500/50 transition-colors">Chennai, India</p>
                        </div>
                ...
                {/* AWS Academy Internship Box (Right) */}
                <motion.div 
                    initial={isLowPowerMode ? {} : { opacity: 0, y: 20 }}
                    whileInView={isLowPowerMode ? {} : { opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                ...
                >
                    ...
                    <div className="p-8 relative z-10 transition-transform duration-500">
                        <div className="flex items-center gap-2 mb-4">
                            <span className="text-xs font-bold uppercase tracking-widest text-neutral-500 dark:text-neutral-400 group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-colors">Virtual Internship • Oct – Dec 2025</span>
                        </div>
                        <h3 className="text-3xl font-black text-neutral-900 dark:text-white mb-4">AWS Academy × AICTE</h3>
                        <p className="text-sm text-neutral-600 dark:text-neutral-400 leading-relaxed">
                            Generative AI Virtual Intern with AICTE, EduSkills, and AWS Academy. Completed 10 weeks of intensive training on Generative AI architectures, LLM fine-tuning, Prompt Engineering, and AWS Cloud AI infrastructure.
                        </p>
                    </div>
                    ...
                    <div className="flex-1 flex items-center justify-center relative p-8 mt-auto border-t border-black/10 dark:border-white/10 bg-gradient-to-b from-transparent to-black/5 dark:to-white/5 overflow-hidden">
                         ...
                         <div className="absolute inset-0">
                            <Image
                                ...
                                alt="AWS Academy GenAI Virtual Internship"
                                fill
                                className="object-cover opacity-25 dark:opacity-35 blur-[1px] scale-110 group-hover:scale-105 transition-transform duration-700"
                            />
                        ...
                        <div className="relative z-10 flex flex-col items-center">
                            ...
                            <div className="flex flex-wrap gap-2 justify-center mb-4">
                                {["Generative AI", "AWS Cloud", "LLMs & Prompts"].map(s => (
                            ...
                            <p className="text-[10px] font-mono text-white/90 uppercase tracking-widest bg-black/50 px-2 py-1 rounded backdrop-blur-sm border border-white/10 group-hover:border-orange-500/50 transition-colors">AI & Cloud Certification</p>
                        </div>
                    </div>
                </motion.div>
