...
const CATEGORY_COLORS: Record<string, string> = {
    ...
    'Competitive Programming': '#FFA116',     // LeetCode Orange
    'Cybersecurity': '#00FF88',               // Cyber Green
    'AI & Full-Stack': '#A855F7',             // Purple
    'Healthcare Tech': '#EC4899',             // Pink
    'CTF & Hacking': '#EF4444',              // Red
    'applied-ai': '#9D2127',
...
export default function StatsSection({ scrollYProgress, showOnly }: { scrollYProgress?: any, showOnly?: 'top' | 'bottom' }) {
    ...
    useEffect(() => {
        const galleryImages = [
            { src: '/gallery/hackathon-memory-1.jpg', alt: 'Hackathon Memory 1' },
            { src: '/gallery/hackathon-memory-2.jpg', alt: 'Hackathon Memory 2' },
            { src: '/gallery/hackathon-memory-3.jpg', alt: 'Hackathon Memory 3' },
            { src: '/gallery/hackathon-memory-4.jpg', alt: 'Hackathon Memory 4' },
            { src: '/gallery/hackathon-memory-5.jpg', alt: 'Hackathon Memory 5' },
            { src: '/gallery/hackathon-memory-6.jpg', alt: 'Hackathon Memory 6' },
            { src: '/gallery/hackathon-memory-7.jpg', alt: 'Hackathon Memory 7' },
            { src: '/gallery/hackathon-memory-8.jpg', alt: 'Hackathon Memory 8' },
            { src: '/gallery/hackathon-memory-9.jpg', alt: 'Hackathon Memory 9' },
            { src: '/gallery/hackathon-memory-10.jpg', alt: 'Hackathon Memory 10' },
            { src: '/gallery/hackathon-memory-11.jpg', alt: 'Hackathon Memory 11' },
            { src: '/gallery/hackathon-memory-12.jpg', alt: 'Hackathon Memory 12' },
            { src: '/gallery/hackathon-memory-13.jpg', alt: 'Hackathon Memory 13' },
            { src: '/gallery/hackathon-memory-14.jpg', alt: 'Hackathon Memory 14' },
        ];
            ...
            {(showOnly === 'top' || !showOnly) && (
                <>
                    <div className="max-w-6xl mx-auto px-6 w-full pt-12 md:pt-32 pb-16 text-center space-y-4">
                        ...
                        >
                            A collection of technical write-ups, engineering case studies, and reflections from hackathons, competitive programming, and real-world AI builds.
                        </motion.p>
                    </div>
