...
const skillVisuals: Record<string, string> = {
    'Leadership': '/images/nithish-about.jpg',
    'Communication': '/images/queuecure-preview.jpg',
    'Problem Solving': '/images/timeline-securox.png',
    'Adaptability': '/images/voyage-preview.jpg',
    'Critical Thinking': '/images/timeline-leetcode-cp.png',
    'Public Speaking': '/images/subaero-preview.jpg',
    'Teamwork': '/images/aircraft.jpg',
    'More': '/images/intro-bg.jpg',
};
                ...
                {illustration ? (
                    <div className="relative w-full h-full flex items-center justify-center">
                        ...
                        <Image
                            ...
                            width={320}
                            height={320}
                            className="object-cover rounded-2xl relative z-10 group-hover:scale-105 transition-transform duration-700 opacity-90 group-hover:opacity-100 shadow-md"
                        />
                    </div>
                ) : (
                    ...
                    >
                        ...
                        <div className="relative z-0 flex items-center justify-center w-full h-60 my-10">
                            <Image
                                ...
                                width={320}
                                height={320}
                                className="object-cover rounded-2xl relative z-10 group-hover:scale-105 transition-transform duration-700 opacity-80 group-hover:opacity-100 shadow-md"
                            />
                        </div>
