            ...
            <div className="container max-w-7xl mx-auto px-6 mb-16">
                <div className="flex flex-col md:flex-row items-center justify-between border-y border-border/40 py-6 gap-6">
                    ...
                    <div className="flex items-center gap-3 w-full md:w-auto justify-end">
                        ...
                        <Link href={portfolioData.personal.socialLinks.find(s => s.platform === 'LinkedIn')?.url || 'https://www.linkedin.com/in/nithish-bharathwaj-n-847a00379'} target="_blank" className="p-2 text-muted-foreground hover:text-primary transition-colors bg-secondary/10 rounded-lg hover:bg-primary/10">
                            <Linkedin className="w-4 h-4" />
                        </Link>
                        <Link href={portfolioData.personal.socialLinks.find(s => s.platform === 'GitHub')?.url || 'https://github.com/Nithish-Bharathwaj-N'} target="_blank" className="p-2 text-muted-foreground hover:text-primary transition-colors bg-secondary/10 rounded-lg hover:bg-primary/10">
                            ...
                            <div className="relative w-full aspect-[16/9] rounded-2xl overflow-hidden mb-6 bg-secondary/5 border border-border/40">
                                ...
                                <div className="absolute bottom-4 left-4">
                                    <span className="px-3 py-1 bg-black/50 backdrop-blur-md border border-white/10 rounded-full text-[10px] font-bold text-white uppercase tracking-wider">
                                        {t.has(`categories.${b.category}`) ? t(`categories.${b.category}`) : b.category}
                                    </span>
                                </div>
                            </div>
