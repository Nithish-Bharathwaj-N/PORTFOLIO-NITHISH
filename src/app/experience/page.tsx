...
const highlightContent = {
    education: {
        ...
        description: "Every line of code starts with deep understanding. My academic journey at Chennai Institute of Technology (B.E. CSE Cyber Security) shapes how I approach complex security & AI problems."
    },
    journey: {
        title: "Crafting Experiences",
        highlight: "That Matter",
        description: "From national hackathons like Aerothon 2026 to AWS Cloud internships, each step drives my passion for building production-ready digital twins & security systems."
    },
    experience: {
        title: "Turning Ideas",
        highlight: "Into Reality",
        description: "Real-world engineering that solves real-world challenges — from WebGL aerospace simulators to autonomous cyber risk scoring."
    }
};
...
function ExperienceTabSlider({ isLowPowerMode }: { isLowPowerMode: boolean }) {
    ...
    const tabs: TabItem[] = [
        { id: 'education', label: 'Education', description: 'Building strong foundations through academic excellence at Chennai Institute of Technology and AWS Academy.' },
        { id: 'journey', label: 'Journey', description: 'A timeline of hackathons, projects, competitive programming, and AWS Cloud AI training.' },
        { id: 'experience', label: 'Experience', description: 'Detailed breakdown of engineering projects, aerospace digital twins, and security platforms.' },
    ];
                    ...
                    <div className="flex-1 space-y-3">
                        ...
                        <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-sm text-neutral-500 dark:text-neutral-500 font-medium">
                            <span className="text-neutral-700 dark:text-neutral-300">
                                {exp.customTimeline || `${formatDate(exp.startDate)} - ${exp.endDate ? formatDate(exp.endDate) : t('present')}`}
                            </span>
                            <span className="w-1 h-1 rounded-full bg-neutral-300 dark:bg-neutral-700" />
                        ...
                        <div className="mb-2 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                            ...
                            <div className="flex flex-col sm:items-end gap-2">
                                <span className="text-[10px] font-mono font-bold uppercase tracking-widest text-neutral-500 dark:text-neutral-400 bg-neutral-100 dark:bg-neutral-900 px-2 py-1 rounded w-fit">
                                    {exp.customTimeline || `${formatDate(exp.startDate)} - ${exp.endDate ? formatDate(exp.endDate) : 'Present'}`}
                                </span>
                            </div>
                        </div>
