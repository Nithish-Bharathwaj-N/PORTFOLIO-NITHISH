...
export interface Skill {
    ...
    category: 'frontend' | 'backend' | 'database' | 'devops' | 'mobile' | 'ai' | 'data' | 'blockchain' | 'software' | 'cloud' | 'cybersecurity' | 'other';
    description?: string;
}
...
export interface TechStack {
    name: string;
    icon: string;
    category: 'language' | 'framework' | 'library' | 'database' | 'cloud' | 'tool' | 'ai';
    url?: string;
